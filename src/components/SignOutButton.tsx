...
export function SignOutButton() {
  return (
    <button
      ...
      className="group flex w-full items-center gap-3 rounded-xl px-3 py-2.5 text-muted-foreground transition-all duration-150 hover:bg-red-50 hover:text-red-500"
      title="Sair"
    >
